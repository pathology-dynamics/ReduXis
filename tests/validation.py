...
if __name__ == "__main__":
    ...
    group.add_argument(
        ...
        choices=[i.__name__.lower() for i in sSuStaIn.AbstractSustain.__subclasses__()] + [i.__name__.lower().replace("sustain", "") for i in sSuStaIn.AbstractSustain.__subclasses__()],
        help="Name of single class to create new validation"
    )
    args = parser.parse_args()
    # Test all sustain subclasses
    if args.full:
        sustain_classes = sSuStaIn.AbstractSustain.__subclasses__()
    # Otherwise test a single class
        ...
        class_dict = {
            i.__name__.lower(): i for i in sSuStaIn.AbstractSustain.__subclasses__()
        }
